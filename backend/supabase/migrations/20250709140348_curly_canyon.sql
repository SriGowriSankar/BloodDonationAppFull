...
INSERT INTO hospitals (id, user_id, name, email, phone, address, city, state, zip_code, license_number, emergency_contact) VALUES
  ('h1111111-1111-1111-1111-111111111111', '55555555-5555-5555-5555-555555555555', 'General Hospital', 'hospital1@example.com', '555-0301', '400 Hospital St', 'New York', 'NY', '10001', 'H-NY-001', '555-0399'),
  ('h2222222-2222-2222-2222-222222222222', null, 'St. Mary Medical Center', 'admin@stmarymedical.com', '555-0302', '500 Care Blvd', 'Los Angeles', 'CA', '90001', 'H-CA-002', '555-0399'),
  ('h3333333-3333-3333-3333-333333333333', null, 'University Hospital', 'info@universityhospital.edu', '555-0303', '600 Campus Dr', 'Chicago', 'IL', '60001', 'H-IL-003', '555-0399')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO blood_requests (id, hospital_id, blood_type, units_needed, priority, patient_name, patient_age, reason, status, requested_date, required_by) VALUES
  ('r1111111-1111-1111-1111-111111111111', 'h1111111-1111-1111-1111-111111111111', 'O+', 3, 'high', 'John Doe', 45, 'Emergency surgery', 'pending', '2024-03-01', '2024-03-02'),
  ('r2222222-2222-2222-2222-222222222222', 'h1111111-1111-1111-1111-111111111111', 'A+', 2, 'medium', 'Jane Smith', 32, 'Scheduled surgery', 'approved', '2024-03-01', '2024-03-05'),
  ('r3333333-3333-3333-3333-333333333333', 'h2222222-2222-2222-2222-222222222222', 'B+', 1, 'emergency', 'Bob Johnson', 28, 'Trauma patient', 'fulfilled', '2024-02-28', '2024-03-01'),
  ('r4444444-4444-4444-4444-444444444444', 'h2222222-2222-2222-2222-222222222222', 'AB-', 2, 'high', 'Alice Brown', 56, 'Cancer treatment', 'pending', '2024-03-01', '2024-03-03'),
  ('r5555555-5555-5555-5555-555555555555', 'h3333333-3333-3333-3333-333333333333', 'O-', 4, 'emergency', 'Charlie Davis', 67, 'Heart surgery', 'pending', '2024-03-01', '2024-03-02')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO donations (id, donor_id, blood_bank_id, blood_type, units_donated, donation_date, hemoglobin_level, blood_pressure, temperature, weight, status) VALUES
  ('don11111-1111-1111-1111-111111111111', 'd1111111-1111-1111-1111-111111111111', 'b1111111-1111-1111-1111-111111111111', 'O+', 1, '2024-02-15', 14.2, '120/80', 98.6, 175.5, 'completed'),
  ('don22222-2222-2222-2222-222222222222', 'd2222222-2222-2222-2222-222222222222', 'b1111111-1111-1111-1111-111111111111', 'A+', 1, '2024-02-20', 13.8, '115/75', 98.4, 145.2, 'completed'),
  ('don33333-3333-3333-3333-333333333333', 'd3333333-3333-3333-3333-333333333333', 'b1111111-1111-1111-1111-111111111111', 'B+', 1, '2024-02-10', 15.1, '125/82', 98.8, 185.0, 'completed'),
  ('don44444-4444-4444-4444-444444444444', 'd5555555-5555-5555-5555-555555555555', 'b1111111-1111-1111-1111-111111111111', 'O-', 1, '2024-02-18', 14.7, '118/76', 98.5, 165.8, 'completed'),
  ('don55555-5555-5555-5555-555555555555', 'd6666666-6666-6666-6666-666666666666', 'b2222222-2222-2222-2222-222222222222', 'A-', 1, '2024-02-12', 13.5, '110/70', 98.2, 135.4, 'completed'),
  ('don66666-6666-6666-6666-666666666666', 'd7777777-7777-7777-7777-777777777777', 'b2222222-2222-2222-2222-222222222222', 'B-', 1, '2024-02-22', 14.9, '122/79', 98.7, 172.3, 'completed'),
  ('don77777-7777-7777-7777-777777777777', 'd8888888-8888-8888-8888-888888888888', 'b2222222-2222-2222-2222-222222222222', 'AB+', 1, '2024-02-16', 13.9, '116/74', 98.3, 152.1, 'completed'),
  ('don88888-8888-8888-8888-888888888888', 'd1111111-1111-1111-1111-111111111111', 'b1111111-1111-1111-1111-111111111111', 'O+', 1, '2024-03-05', 14.0, '119/77', 98.6, 176.2, 'scheduled')
ON CONFLICT (id) DO NOTHING;